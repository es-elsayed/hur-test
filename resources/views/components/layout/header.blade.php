    ...
    <div class="container px-4 py-4 mx-auto">
        <div class="flex justify-between items-center">
            <div class="flex gap-2 items-center">
                ...
                <span class="text-xl font-bold text-gray-800">منصة باشنور</span>
            </div>
            <nav class="hidden gap-8 items-center md:flex">
                <a href="#" class="flex gap-1 items-center text-gray-600 hover:text-gray-800">
                    البحث عن فريلانسر
            ...
            <div class="flex gap-4 items-center">
                ...
                <button class="p-1 rounded-full hover:bg-gray-100">
                    <svg class="w-6 h-6 text-gray-600" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512" xml:space="preserve" fill="#4b5563" stroke="#4b5563"
                ...
                <button class="p-1 rounded-full hover:bg-gray-100">
                    <svg class="w-6 h-6 text-gray-600" fill="#4b5563" viewBox="0 0 24 24" stroke="#000000"
